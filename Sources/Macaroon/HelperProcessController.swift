...
final class HelperProcessController: NSObject, BridgeService {
    ...
    private func handleOutputChunk(_ chunk: Data) {
        ...
        while let newlineIndex = outputBuffer.firstIndex(of: 0x0A) {
            ...
            do {
                if let inbound = try Self.decodeInboundMessage(Data(line), decoder: decoder) {
                    switch inbound {
    ...
    private static func decodeInboundMessage(_ data: Data, decoder: JSONDecoder) throws -> BridgeInboundMessage? {
